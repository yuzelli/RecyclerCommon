...
/**
 * Created by 51644 on 2018/4/3.
 */

public abstract class RecyclerCommonAdapter<T> extends RecyclerView.Adapter<BaseRecyclerHolder> {
    ...
    public RecyclerCommonAdapter(Context context, List<T> list, int itemLayoutId) {
